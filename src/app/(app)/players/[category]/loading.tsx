// Teams-list route loader — mirrors the live screen: green→blue DNA header
    ...
    <main className="mx-auto flex min-h-dvh w-full max-w-2xl flex-col" dir="rtl">
      <header className="pitch-band pitch-band--home flex items-center gap-3 px-5 pb-6 pt-7 lg:rounded-b-[28px]">
        ...
        <div className="flex flex-1 flex-col gap-1.5">
          <div className="h-5 w-28 rounded bg-white/35" />
      ...
      <div className="flex flex-col gap-2.5 px-5 pt-3.5">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="alive-card flex items-center gap-3.5 p-3.5">
            <div className="h-[52px] w-[52px] flex-none rounded-2xl skl" />
            <div className="flex flex-1 flex-col gap-1.5">
              <div className="h-4 w-32 skl" />
